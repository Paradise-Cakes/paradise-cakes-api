...
resource "aws_route53_record" "paradise_cakes_api_ns" {
  ...
  records = [
    data.aws_route53_zone.paradise_cakes.name_servers[0],
    data.aws_route53_zone.paradise_cakes.name_servers[1],
    data.aws_route53_zone.paradise_cakes.name_servers[2],
    data.aws_route53_zone.paradise_cakes.name_servers[3],
  ]
}
